...
<div class="container-fluid">
    <div class="card p-4">
        <h5 class="mb-3">Edit User: <?php echo e($user->name); ?></h5>
        <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?> <!-- This is to indicate an update operation -->
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control select2" id="allergies" name="allergies[]" multiple>
                        <?php $__currentLoopData = $allergies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($allergy->id); ?>" <?php echo e(in_array($allergy->id, $user->allergies->pluck('id')->toArray()) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abbas\OneDrive\Desktop\ShopMain\shop\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>