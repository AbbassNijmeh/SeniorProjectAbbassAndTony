    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3"><?php echo e($setting->name); ?> - Dashboard</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link " href="<?php echo e(route('allergies.index')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link " href="<?php echo e(route('settings.show')); ?>">
...
<?php /**PATH C:\Users\abbas\OneDrive\Desktop\ShopMain\shop\resources\views/layouts/admin.blade.php ENDPATH**/ ?>