...
<div class="hero-wrap" style="background-image: url(<?php echo e(asset('assets/img/bg-1.jpg')); ?>);"
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-8 ftco-animate d-flex align-items-end">
                <div class="text w-100 text-center">
                    ...
                    <p>
                        <a href="<?php echo e(route('products')); ?>" class="btn btn-primary py-2 px-4">Shop Now</a>
    ...
    <section class="ftco-section ftco-no-pb">
        <div class="container">
                ...
                <div class="col-md-3 d-flex">
                    <div class="product ftco-animate">
                        ...
                        <div class="text text-center">
                            <span class="category"><a href="#"><?php echo e($product->category->name); ?></a></span>
                            <h2><?php echo e($product->name); ?></h2>
                            <div class="rating">
                                <?php for($i = 1; $i <= 5; $i++): ?> <?php if($i <=$product->rating): ?>
                                    <i class="fas fa-star"></i>
                                    <?php elseif($i == ceil($product->rating)): ?>
            ...
            <div class="row justify-content-center py-2">
                <div class="col-md-4">
                    <a href="<?php echo e(route('products')); ?>" class="btn btn-primary d-block">View All Products <span
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abbas\OneDrive\Desktop\ShopMain\shop\resources\views/welcome.blade.php ENDPATH**/ ?>