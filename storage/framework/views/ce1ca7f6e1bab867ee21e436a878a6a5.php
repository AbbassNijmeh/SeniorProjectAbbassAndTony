    ...
    <nav aria-label="breadcrumb" class="glass-morphism">
        <ol class="breadcrumb bg-transparent p-3 rounded-3">
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('dashboard.index')); ?>" class="text-decoration-none text-primary">
                    <i class="fas fa-home me-1"></i>Dashboard
                </a>
            </li>
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('products.index')); ?>" class="text-decoration-none text-primary">
                    <i class="fas fa-boxes me-1"></i>Products
                </a>
            </li>
            <li class="breadcrumb-item active text-muted" aria-current="page">
                <i class="fas fa-tag me-1"></i>#<?php echo e($product->id); ?>
    ...
    <div class="card glass-morphism border-0 overflow-hidden">
        <div class="card-header bg-gradient-primary text-white py-4 position-relative">
            ...
            <h2 class="mb-0 fw-light">
                <i class="fas fa-box-open me-2"></i><?php echo e($product->name); ?>
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-5">
                    <div class="image-container hover-scale">
                        ...
                        <button class="btn btn-danger btn-floating delete-pic-btn" data-id="<?php echo e($product->id); ?>"
                            data-image="<?php echo e($product->image); ?>" data-bs-toggle="modal" data-bs-target="#deletePicModal">
                    ...
                    <div class="detail-grid">
                        <div class="detail-card">
                            ...
                            <div>
                                ...
                                <h5 class="mb-0">#<?php echo e($product->id); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="detail-card">
                            ...
                            <div>
                                ...
                                <h5 class="mb-0"><?php echo e($product->category->name); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="pricing-card bg-gradient-warning text-white">
                            <div class="price-item">
                                ...
                                <h3>$<?php echo e(number_format($product->cost_price, 2)); ?></h3>
                            </div>
                            <div class="price-item">
                        ...
                        <div class="detail-card">
                            ...
                            <div>
                                ...
                                <h5 class="mb-0"><?php echo e($product->stock_quantity); ?> units</h5>
                            </div>
                        </div>
                        ...
                        <div class="specs-grid">
                            <div class="spec-item">
                                ...
                                <span><?php echo e(number_format($product->weight,2)); ?>g</span>
                            </div>
                            <div class="spec-item">
                                <i class="fas fa-expand"></i>
                                <span><?php echo e($product->dimensions); ?></span>
                            </div>
                            <div class="spec-item">
            ...
            <div class="review-card">
                <div class="user-info">
                    ...
                    <div>
                        ...
                        <div class="rating">
                            <?php for($i = 0; $i < 5; $i++): ?> <i
                                class="fas fa-star<?php echo e($i < $review->rating ? ' text-warning' : ' text-secondary'); ?>"></i>
                                <?php endfor; ?>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="deletePicModal" tabindex="-1" aria-labelledby="deletePicModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="deletePicForm" action="<?php echo e(route('products.deletePic')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abbas\OneDrive\Desktop\ShopMain\shop\resources\views/admin/product/details.blade.php ENDPATH**/ ?>