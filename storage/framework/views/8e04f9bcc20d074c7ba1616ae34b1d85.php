    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="order-card" data-order-id="<?php echo e($order->id); ?>" data-name="<?php echo e($order->user->name); ?>"
                    data-phone="<?php echo e($order->user->phone); ?>" data-lat="<?php echo e($order->userAddress->latitude); ?>"
                    data-lng="<?php echo e($order->userAddress->longtitude); ?>" data-address="<?php if($order->userAddress->location_link): ?>
                      <?php echo e($order->userAddress->location_link); ?>
                   ...
                   <?php endif; ?>">
                    ...
                    <p class="h5"><?php echo e($order->user->name); ?>, Order #<?php echo e($order->id); ?></p>
                    <p class="h5">Phone number: <?php echo e($order->user->phone); ?></p>
                    <span class="badge bg-success status-badge"><?php echo e(ucfirst($order->status)); ?></span>
                    ...
                    <p>
                        ...
                        <?php else: ?>
                        <?php echo e($order->userAddress->street); ?>, <?php echo e($order->userAddress->building); ?>,
                        <?php echo e($order->userAddress->city); ?>, <?php echo e($order->userAddress->country); ?>
                    ...
                    <div class="total-price-card">
                        ...
                        $<?php echo e(number_format($order->orderItems->sum(fn($item) => ($item->product->price ?? 0) *
                        $item->quantity), 2)); ?>
                    ...
                    <ul class="order-items-collapse collapsed mt-2">
                        ...
                        <li><?php echo e($item->quantity); ?> x <?php echo e($item->product->name ?? 'Unknown Product'); ?>
                ...
                <div class="modal fade" id="otpModal" tabindex="-1" role="dialog" aria-labelledby="otpModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <form method="POST" action="<?php echo e(route('delivery.completed')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\abbas\OneDrive\Desktop\ShopMain\shop\resources\views/delivery/index.blade.php ENDPATH**/ ?>